...
# Categories to map with user input
geoapify_categories = {
    "accommodation",
    "accommodation.hotel",
    "accommodation.hut",
...
def create_embeddings(text_list, filename):
    embeddings = {}
...
# Generate and save
create_embeddings(geoapify_categories, "category_embeddings.json")
create_embeddings(geoapify_conditions, "condition_embeddings.json")
